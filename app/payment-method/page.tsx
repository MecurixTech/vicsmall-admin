...
export default function Page() {
  ...
  const updateCurrencySymbol = (index: number, symbol: string) => {
    setCurrencies((curr) =>
      curr.map((currency, i) =>
        i === index ? { ...currency, symbol } : currency,
      ),
    );
  };
  ...
  const updateExchangeRate = (index: number, rate: string) => {
    setCurrencies((curr) =>
      curr.map((currency, i) =>
        i === index ? { ...currency, exchangeRate: rate } : currency,
      ),
    );
  };
  ...
  return (
    <div className="min-h-screen overflow-x-scroll bg-gray-50 p-6">
      {/* Payment Methods Section */}
      <div className="mb-8 min-w-[768px] rounded-lg bg-white shadow">
        ...
        {paymentMethods.map((method, index) => (
          <div
            ...
            className="grid grid-cols-[1fr_100px_2fr_100px] items-center border-b border-gray-200 p-4"
          >
      ...
      <div>
        ...
        <div className="min-w-[768px] rounded-lg bg-white shadow">
            ...
            >
              <div>
                <Switch
                  ...
                  onCheckedChange={() => toggleDefaultCurrency(index)}
                />
              </div>
              <div>
              ...
              <div className="col-span-3">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setNewCurrency({ ...newCurrency, isDefault: checked })
                  }
                />
              </div>
            </div>
