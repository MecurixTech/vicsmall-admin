            ...
            <tbody>
              {orders.map((order: Order) => (
                <tr key={order.order_id} className="border-b">
                  ...
                  <td className="p-2">
                    <span
                      className={`rounded-full px-4 py-1 text-sm ${statusStyles[order.status.toLowerCase() as keyof typeof statusStyles]}`}
                    >
